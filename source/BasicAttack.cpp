...
void CBasicAttack::Update(float fElapsedTime)
{
	...
	else if (GetOwner()->GetName() == "Tree" || GetOwner()->GetName() == "Orc" || GetOwner()->GetName() == "Snail" || GetOwner()->GetName() == "Pathetic_Orc" || GetOwner()->GetName() == "Orc_Leader" || GetOwner()->GetName() == "Orc_Shaman" || GetOwner()->GetName() == "Cave_Spider" || GetOwner()->GetName() == "Cave_Bat" || GetOwner()->GetName() == "Ogre")
	{
